...
import { FirebaseError as _, isCloudWorkstation as c, base64 as l, DecodeBase64StringError as h, getDefaultEmulatorHostnameAndPort as d, pingServer as f, deepEqual as E, createMockUserToken as m, getModularInstance as T } from "@firebase/util";
...
function __PRIVATE__fail(t, e, r) {
    ...
    let n = `FIRESTORE (${R}) INTERNAL ASSERTION FAILED: ${e} (ID: ${t.toString(16)})`;
    if (void 0 !== r) try {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const V = "ok", p = "cancelled", y = "unknown", g = "invalid-argument", w = "deadline-exceeded", F = "not-found", v = "already-exists", D = "permission-denied", b = "unauthenticated", C = "resource-exhausted", S = "failed-precondition", N = "aborted", O = "out-of-range", q = "unimplemented", B = "internal", $ = "unavailable", Q = "data-loss";
 ...
 */ class ResourcePath extends BasePath {
     ...
     */    static fromString(...t) {
        ...
        const e = [];
        for (const r of t) {
            if (r.indexOf("//") >= 0) throw new FirestoreError(g, `Invalid segment (${r}). Paths must not contain // in them.`);
 ...
 */ class FieldPath$1 extends BasePath {
     ...
     */    static fromServerFormat(t) {
        ...
        const __PRIVATE_addCurrentSegment = () => {
            if (0 === r.length) throw new FirestoreError(g, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            e.push(r), r = "";
        };
        let i = !1;
        for (;n < t.length; ) {
            const e = t[n];
            if ("\\" === e) {
                if (n + 1 === t.length) throw new FirestoreError(g, "Path has trailing escape character: " + t);
                const e = t[n + 1];
                if ("\\" !== e && "." !== e && "`" !== e) throw new FirestoreError(g, "Path has invalid escape sequence: " + t);
                r += e, n += 2;
            } else "`" === e ? (i = !i, n++) : "." !== e || i ? (r += e, n++) : (__PRIVATE_addCurrentSegment(), 
            n++);
        }
        if (__PRIVATE_addCurrentSegment(), i) throw new FirestoreError(g, "Unterminated ` in path: " + t);
 ...
 */ function __PRIVATE_validateNonEmptyArgument(t, e, r) {
    if (!r) throw new FirestoreError(g, `Function ${t}() cannot be called with an empty ${e}.`);
}
...
function __PRIVATE_validateDocumentPath(t) {
    if (!DocumentKey.isDocumentKey(t)) throw new FirestoreError(g, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function __PRIVATE_validateCollectionPath(t) {
    if (DocumentKey.isDocumentKey(t)) throw new FirestoreError(g, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new FirestoreError(g, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        {
            const r = __PRIVATE_valueDescription(t);
            throw new FirestoreError(g, `Expected type '${e.name}', but it was: ${r}`);
        }
    }
    return t;
}
...
function __PRIVATE_validatePositiveNumber(t, e) {
    if (e <= 0) throw new FirestoreError(g, `Function ${t}() requires a positive number, but it was: ${e}.`);
}
...
class __PRIVATE_RestConnection {
    ...
    V(t, e, r, n, i) {
        ...
        return this.v(t, o, a, r, _).then((e => (__PRIVATE_logDebug(x, `Received RPC '${t}' ${s}: `, e), 
        e)), (e => {
...
function __PRIVATE_mapCodeFromHttpStatus(t) {
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? V : t >= 400 && t < 500 ? S : t >= 500 && t < 600 ? B : y;
    }
}
...
class Timestamp {
     ...
     */    static fromMillis(t) {
        const e = Math.floor(t / 1e3), r = Math.floor((t - 1e3 * e) * J);
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new FirestoreError(g, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new FirestoreError(g, "Timestamp nanoseconds out of range: " + e);
        if (t < H) throw new FirestoreError(g, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new FirestoreError(g, "Timestamp seconds out of range: " + t);
    }
    /**
     ...
     */    toMillis() {
        return 1e3 * this.seconds + this.nanoseconds / J;
    }
    _compareTo(t) {
 ...
 */ (t) ? 9007199254740991 /* TypeOrder.MaxValue */ : 
    ...
    function __PRIVATE_isVectorValue(t) {
        var e, r;
        const n = null === (r = ((null === (e = null == t ? void 0 : t.mapValue) || void 0 === e ? void 0 : e.fields) || {})[Y]) || void 0 === r ? void 0 : r.stringValue;
        return n === tt;
    }
    ...
    switch (r) {
      ...
      case 10 /* TypeOrder.VectorValue */ :
        return function __PRIVATE_compareVectors(t, e) {
            var r, n, i, s;
            const o = t.fields || {}, a = e.fields || {}, u = null === (r = o[et]) || void 0 === r ? void 0 : r.arrayValue, _ = null === (n = a[et]) || void 0 === n ? void 0 : n.arrayValue, c = __PRIVATE_primitiveComparator((null === (i = null == u ? void 0 : u.values) || void 0 === i ? void 0 : i.length) || 0, (null === (s = null == _ ? void 0 : _.values) || void 0 === s ? void 0 : s.length) || 0);
            if (0 !== c) return c;
...
function fromName(t, e) {
    ...
    if (r.get(1) !== t.databaseId.projectId) throw new FirestoreError(g, "Tried to deserialize key from different project: " + r.get(1) + " vs " + t.databaseId.projectId);
    if (r.get(3) !== t.databaseId.database) throw new FirestoreError(g, "Tried to deserialize key from different database: " + r.get(3) + " vs " + t.databaseId.database);
 ...
 */ class __PRIVATE_DatastoreImpl extends Datastore {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */    V(t, e, r, n) {
        return this.rt(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([i, s]) => this.connection.V(t, __PRIVATE_toResourcePath(e, r), n, i, s))).catch((t => {
            ...
            this.appCheckCredentials.invalidateToken()), t) : new FirestoreError(y, t.toString());
        }));
    }
...
class FirestoreSettingsImpl {
    constructor(t) {
        var e, r;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new FirestoreError(g, "Can't provide ssl option if host option is not set");
            this.host = ut, this.ssl = _t;
        } else this.host = t.host, this.ssl = null !== (e = t.ssl) && void 0 !== e ? e : _t;
        ...
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < at) throw new FirestoreError(g, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        !function __PRIVATE_validateIsNotUsedTogether(t, e, r, n) {
            if (!0 === e && !0 === n) throw new FirestoreError(g, `${t} and ${r} cannot be used together.`);
        ...
        function __PRIVATE_validateLongPollingOptions(t) {
            if (void 0 !== t.timeoutSeconds) {
                if (isNaN(t.timeoutSeconds)) throw new FirestoreError(g, `invalid long polling timeout: ${t.timeoutSeconds} (must not be NaN)`);
                if (t.timeoutSeconds < 5) throw new FirestoreError(g, `invalid long polling timeout: ${t.timeoutSeconds} (minimum allowed value is 5)`);
                if (t.timeoutSeconds > 30) throw new FirestoreError(g, `invalid long polling timeout: ${t.timeoutSeconds} (maximum allowed value is 30)`);
            }
        }
        /**
 * @license
    ...
    _setSettings(t) {
        ...
        void 0 !== t.credentials && (this._authCredentials = function __PRIVATE_makeAuthCredentialsProvider(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new FirestoreError(g, "makeAuthCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
    }
    _getSettings() {
 ...
 */ function connectFirestoreEmulator(t, e, r, n = {}) {
    ...
    s && f(`https://${u}`), o.host !== ut && o.host !== u && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
    ...
    // enviornments which might call `connectFirestoreEmulator` multiple times as a standard practice.
        ...
        if ("string" == typeof n.mockUserToken) e = n.mockUserToken, r = User.MOCK_USER; else {
            ...
            e = m(n.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
            const s = n.mockUserToken.sub || n.mockUserToken.user_id;
            if (!s) throw new FirestoreError(g, "mockUserToken must contain 'sub' or 'user_id' field!");
            r = new User(s);
        }
...
function collection(t, e, ...r) {
    if (t = T(t), __PRIVATE_validateNonEmptyArgument("collection", "path", e), t instanceof Firestore) {
        const n = ResourcePath.fromString(e, ...r);
        return __PRIVATE_validateCollectionPath(n), new CollectionReference(t, /* converter= */ null, n);
    }
    {
        if (!(t instanceof DocumentReference || t instanceof CollectionReference)) throw new FirestoreError(g, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function collectionGroup(t, e) {
    ...
    e.indexOf("/") >= 0) throw new FirestoreError(g, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Query(t, 
 ...
 */ function refEqual(t, e) {
    return t = T(t), e = T(e), (t instanceof DocumentReference || t instanceof CollectionReference) && (e instanceof DocumentReference || e instanceof CollectionReference) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 */ function queryEqual(t, e) {
    return t = T(t), e = T(e), t instanceof Query && e instanceof Query && (t.firestore === e.firestore && __PRIVATE_queryEquals(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ class Bytes {
     ...
     */    static fromBase64String(t) {
        try {
            ...
            throw new FirestoreError(g, "Failed to construct data from Base64 string: " + t);
        }
    }
    /**
 ...
 */ class FieldPath {
     ...
     */
    constructor(...t) {
        for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new FirestoreError(g, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ class GeoPoint {
     ...
     */
    constructor(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new FirestoreError(g, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new FirestoreError(g, "Longitude must be a number between -180 and 180, but was: " + e);
...
/** A "context" object passed around while parsing user data. */ class __PRIVATE_ParseContextImpl {
    ...
    ct(t) {
        ...
        if (__PRIVATE_isWrite(this.it) && ct.test(t)) throw this.dt('Document fields cannot begin and end with "__"');
    }
}
...
/** Parse document data from a set() call. */ function __PRIVATE_parseSetData(t, e, r, n, i, s = {}) {
    ...
    if (s.merge) u = new FieldMask(o.fieldMask), _ = o.fieldTransforms; else if (s.mergeFields) {
        ...
        for (const n of s.mergeFields) {
            ...
            if (!o.contains(i)) throw new FirestoreError(g, `Field '${i}' is specified in your field mask but missing from your input data.`);
...
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(t, e, r, n, i, s) {
    ...
    if (s.length % 2 != 0) throw new FirestoreError(g, `Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);
 ...
 */ function __PRIVATE_parseData(t, e) {
    ...
    // from firestore-exp.
    t = T(t))) return __PRIVATE_validatePlainObject("Unsupported field value:", e, t), 
 ...
 */ function __PRIVATE_fieldPathFromArgument$1(t, e, r) {
    ...
    // FieldPath.
    e = T(e)) instanceof FieldPath) return e._internalPath;
...
function query(t, e, ...r) {
    ...
    e instanceof AppliableConstraint && n.push(e), n = n.concat(r), function __PRIVATE_validateQueryConstraintArray(t) {
        ...
        if (e > 1 || e > 0 && r > 0) throw new FirestoreError(g, "InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.");
    }
    /**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ class QueryFieldFilterConstraint extends QueryConstraint {
    ...
    _parse(t) {
        const e = __PRIVATE_newUserDataReader(t.firestore), r = function __PRIVATE_newQueryFilter(t, e, r, n, i, s, o) {
            let a;
            if (i.isKeyField()) {
                if ("array-contains" /* Operator.ARRAY_CONTAINS */ === s || "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ === s) throw new FirestoreError(g, `Invalid Query. You can't perform '${s}' queries on documentId().`);
 ...
 */ class QueryOrderByConstraint extends QueryConstraint {
    ...
    _apply(t) {
        const e = function __PRIVATE_newQueryOrderBy(t, e, r) {
            if (null !== t.startAt) throw new FirestoreError(g, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new FirestoreError(g, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(t, e, r, n) {
    if (r[0] = T(r[0]), r[0] instanceof DocumentSnapshot) return function __PRIVATE_newQueryBoundFromDocument(t, e, r, n, i) {
        ...
        // results.
            ...
            if (__PRIVATE_isServerTimestamp(t)) throw new FirestoreError(g, 'Invalid query. You are trying to start or end a query using a document for which the field "' + r.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
                const t = r.field.canonicalString();
                throw new FirestoreError(g, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
            }
            s.push(t);
        }
 ...
 */ (t._query, t.firestore._databaseId, e, r[0]._document, n);
    {
        ...
        return function __PRIVATE_newQueryBoundFromFields(t, e, r, n, i, s) {
            ...
            if (i.length > o.length) throw new FirestoreError(g, `Too many arguments provided to ${n}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
            const a = [];
            for (let s = 0; s < i.length; s++) {
                const u = i[s];
                if (o[s].field.isKeyField()) {
                    if ("string" != typeof u) throw new FirestoreError(g, `Invalid query. Expected a string for document ID in ${n}(), but got a ${typeof u}`);
                    if (!__PRIVATE_isCollectionGroupQuery(t) && -1 !== u.indexOf("/")) throw new FirestoreError(g, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${n}() must be a plain document ID, but '${u}' contains a slash.`);
                    const r = t.path.child(ResourcePath.fromString(u));
                    if (!DocumentKey.isDocumentKey(r)) throw new FirestoreError(g, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${n}() must result in a valid document path, but '${r}' is not because it contains an odd number of segments.`);
...
function __PRIVATE_parseDocumentIdValue(t, e, r) {
    if ("string" == typeof (r = T(r))) {
        if ("" === r) throw new FirestoreError(g, "Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!__PRIVATE_isCollectionGroupQuery(e) && -1 !== r.indexOf("/")) throw new FirestoreError(g, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${r}' contains a '/' character.`);
        const n = e.path.child(ResourcePath.fromString(r));
        if (!DocumentKey.isDocumentKey(n)) throw new FirestoreError(g, `Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${n}' is not because it has an odd number of segments (${n.length}).`);
        return __PRIVATE_refValue(t, new DocumentKey(n));
    }
    if (r instanceof DocumentReference) return __PRIVATE_refValue(t, r._key);
    throw new FirestoreError(g, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${__PRIVATE_valueDescription(r)}.`);
}
 ...
 */ function __PRIVATE_validateDisjunctiveFilterElements(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new FirestoreError(g, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
}
 ...
 */ function __PRIVATE_validateNewFieldFilter(t, e) {
    ...
    throw r === e.op ? new FirestoreError(g, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new FirestoreError(g, `Invalid query. You cannot use '${e.op.toString()}' filters with '${r.toString()}' filters.`);
}

function __PRIVATE_validateQueryFilterConstraint(t, e) {
    if (!(e instanceof QueryFieldFilterConstraint || e instanceof QueryCompositeFilterConstraint)) throw new FirestoreError(g, `Function ${t}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
...
class AbstractUserDataWriter {
     ...
     */    convertVectorValue(t) {
        var e, r, n;
        const i = null === (n = null === (r = null === (e = t.fields) || void 0 === e ? void 0 : e[et].arrayValue) || void 0 === r ? void 0 : r.values) || void 0 === n ? void 0 : n.map((t => __PRIVATE_normalizeNumber(t.doubleValue)));
 ...
 */ function getDocs(t) {
    (function __PRIVATE_validateHasExplicitOrderByForLimitToLast(t) {
        if ("L" /* LimitType.Last */ === t.limitType && 0 === t.explicitOrderBy.length) throw new FirestoreError(q, "limitToLast() queries require specifying at least one orderBy() clause");
...
function updateDoc(t, e, r, ...n) {
    ...
    // performing validation.
        let s;
    s = "string" == typeof (e = T(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(i, "updateDoc", t._key, e, r, n) : __PRIVATE_parseUpdateData(i, "updateDoc", t._key, e);
 ...
 */ class WriteBatch {
    ...
    update(t, e, r, ...n) {
        ...
        // performing validation.
                let s;
        return s = "string" == typeof (e = T(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "WriteBatch.update", i._key, e, r, n) : __PRIVATE_parseUpdateData(this._dataReader, "WriteBatch.update", i._key, e), 
...
function __PRIVATE_validateReference(t, e) {
    if ((t = T(t)).firestore !== e) throw new FirestoreError(g, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ class Transaction$1 {
    ...
    async lookup(t) {
        if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw this.lastTransactionError = new FirestoreError(g, "Firestore transactions require all reads to be executed before all writes."), 
    ...
    recordVersion(t) {
        ...
        if (r) {
            ...
            throw new FirestoreError(N, "Document version changed between two reads.");
     ...
     */    preconditionForUpdate(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new FirestoreError(g, "Can't update a document that doesn't exist.");
 ...
 */ class Transaction {
    ...
    update(t, e, r, ...n) {
        ...
        // performing validation.
                let s;
        return s = "string" == typeof (e = T(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "Transaction.update", i._key, e, r, n) : __PRIVATE_parseUpdateData(this._dataReader, "Transaction.update", i._key, e), 
 ...
 */ function runTransaction(t, e, r) {
    const n = __PRIVATE_getDatastore(t = __PRIVATE_cast(t, Firestore)), i = Object.assign(Object.assign({}, ht), r);
    !function __PRIVATE_validateTransactionOptions(t) {
        if (t.maxAttempts < 1) throw new FirestoreError(g, "Max attempts must be at least 1");
    }(i);
 ...
 */ !function __PRIVATE_registerFirestore() {
    !function __PRIVATE_setSDKVersion(t) {
        ...
        const n = t.getProvider("app").getImmediate(), i = new Firestore(new __PRIVATE_LiteAuthCredentialsProvider(t.getProvider("auth-internal")), new __PRIVATE_LiteAppCheckTokenProvider(n, t.getProvider("app-check-internal")), function __PRIVATE_databaseIdFromApp(t, e) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new FirestoreError(g, '"projectId" not provided in firebase.initializeApp.');
            return new DatabaseId(t.options.projectId, e);
        }(n, e), n);
        return r && i._setSettings(r), i;
    }), "PUBLIC").setMultipleInstances(!0)), 
    // RUNTIME_ENV and BUILD_TARGET are replaced by real values during the compilation
    i("firestore-lite", P, "rn"), i("firestore-lite", P, "esm2017");
}();
