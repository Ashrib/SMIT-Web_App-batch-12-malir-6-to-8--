 ...
 * limitations under the License.
 */
const P = new Logger("@firebase/firestore");
...
class __PRIVATE_RestConnection {
    ...
    V(t, e, r, n, i) {
        ...
        return this.v(t, o, a, r, _).then((e => (__PRIVATE_logDebug(M, `Received RPC '${t}' ${s}: `, e), 
        e)), (e => {
...
class Timestamp {
     ...
     */    static fromMillis(t) {
        const e = Math.floor(t / 1e3), r = Math.floor((t - 1e3 * e) * K);
    ...
    e) {
        ...
        if (t < W) throw new FirestoreError(p, "Timestamp seconds out of range: " + t);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const G = "__type__", H = "__max__", J = {
    fields: {
        __type__: {
            stringValue: H
        }
    }
}, Y = "__vector__", Z = "value";
 ...
 */ (t) ? 9007199254740991 /* TypeOrder.MaxValue */ : 
    ...
    function __PRIVATE_isVectorValue(t) {
        var e, r;
        const n = null === (r = ((null === (e = null == t ? void 0 : t.mapValue) || void 0 === e ? void 0 : e.fields) || {})[G]) || void 0 === r ? void 0 : r.stringValue;
        return n === Y;
    }
    ...
    switch (r) {
      ...
      case 10 /* TypeOrder.VectorValue */ :
        return function __PRIVATE_compareVectors(t, e) {
            var r, n, i, s;
            const o = t.fields || {}, a = e.fields || {}, u = null === (r = o[Z]) || void 0 === r ? void 0 : r.arrayValue, _ = null === (n = a[Z]) || void 0 === n ? void 0 : n.arrayValue, c = __PRIVATE_primitiveComparator((null === (i = null == u ? void 0 : u.values) || void 0 === i ? void 0 : i.length) || 0, (null === (s = null == _ ? void 0 : _.values) || void 0 === s ? void 0 : s.length) || 0);
            if (0 !== c) return c;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const rt = "ComponentProvider", nt = new Map;
...
function __PRIVATE_getDatastore(t) {
    ...
    if (!nt.has(t)) {
        __PRIVATE_logDebug(rt, "Initializing Datastore");
 ...
 * limitations under the License.
 */
const it = 1048576, st = "firestore.googleapis.com", ot = !0;
...
class FirestoreSettingsImpl {
    constructor(t) {
        ...
        if (void 0 === t.host) {
            ...
            this.host = st, this.ssl = ot;
        } else this.host = t.host, this.ssl = null !== (e = t.ssl) && void 0 !== e ? e : ot;
        ...
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < it) throw new FirestoreError(p, "cacheSizeBytes must be at least 1048576");
...
class Firestore {
     ...
     */    _terminate() {
        return function __PRIVATE_removeComponents(t) {
            const e = nt.get(t);
            e && (__PRIVATE_logDebug(rt, "Removing Datastore"), nt.delete(t), e.terminate());
 ...
 */ function connectFirestoreEmulator(t, e, r, n = {}) {
    ...
    s && pingServer(`https://${u}`), o.host !== st && o.host !== u && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
...
/** A "context" object passed around while parsing user data. */ class __PRIVATE_ParseContextImpl {
    ...
    ct(t) {
        ...
        if (__PRIVATE_isWrite(this.it) && at.test(t)) throw this.dt('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ function __PRIVATE_fieldPathFromDotSeparatedString(t, e, r) {
    if (e.search(ut) >= 0) throw __PRIVATE_createError(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
...
class AbstractUserDataWriter {
     ...
     */    convertVectorValue(t) {
        var e, r, n;
        const i = null === (n = null === (r = null === (e = t.fields) || void 0 === e ? void 0 : e[Z].arrayValue) || void 0 === r ? void 0 : r.values) || void 0 === n ? void 0 : n.map((t => __PRIVATE_normalizeNumber(t.doubleValue)));
...
class __PRIVATE_AsyncQueueImpl {
    constructor(t = Promise.resolve()) {
        ...
        this.Bt = () => {
            const t = getDocument();
            t && __PRIVATE_logDebug(ct, "Visibility state changed to " + t.visibilityState), 
            this.Vt.tt();
        }, this.$t = t;
        const e = getDocument();
 ...
 */
 ...
 // Failure will be handled by AsyncQueue
                                __PRIVATE_logDebug(ct, "Operation failed with retryable error: " + t);
            }
            this.Dt.length > 0 && 
 ...
 */ function runTransaction(t, e, r) {
    const n = __PRIVATE_getDatastore(t = __PRIVATE_cast(t, Firestore)), i = Object.assign(Object.assign({}, _t), r);
 ...
 */ !function __PRIVATE_registerFirestore() {
    ...
    registerVersion("firestore-lite", T, ""), registerVersion("firestore-lite", T, "esm2017");
}();
